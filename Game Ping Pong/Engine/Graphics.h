...
public:
	...
	void DrawSolidCircle( int a, int b, int r, Color c);
	void DrawOutlineCircle(int a, int b, int r, Color c);

	void DrawRect(int x0, int y0, int x1, int y1, Color c);
	void DrawRect(int x0, int y0, int x1, int y1, int r, int g, int b);
	void DrawRectDim(int x, int y, int w, int h, Color c);
	void DrawRectDim(int x, int y, int w, int h, int r, int g, int b);
